...
d = 0.37 * (1/math.sqrt(2*math.pi*(0.09**2))) * math.exp(-(1/((2*0.09**2))*(6.9-6.12)**2))
d1 = 0.29 * (1/math.sqrt(2*math.pi*(0.13**2))) * math.exp(-(1/(2*(0.13**2))*(6.9-6.55)**2))
...
x2= np.array([0, 0, 1, 0, 0, 1, 0, 1])
x4= np.array([0, 1, 0, 0, 0, 1, 0, 1])
x1= np.array([0, 0, 1, 0, 0, 0, 0, 1])
